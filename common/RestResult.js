...
RestResult.MESSAGE_ERROR_DESCRIPTION = "短信未能发送";//服务器未知错误
RestResult.MESSAGE_ERROR_CODE = 7;//目标不存在错误
RestResult.TEST_FINISHED_ERROR_CODE = 8;//服务器未知错误
RestResult.TEST_FINISHED_ERROR_DESCRIPTION = "测验已经结束";//服务器未知错误
